...
def train_vae(model_type,model_parameters,train_dataloader,val_dataloader,epochs,lr,device,period):
    ...
    for epoch in range(1,epochs+1):
        ...
        if val_loss<min_loss:
            min_loss=val_loss
            best_epoch=epoch
            torch.save(model.state_dict(),f'./tmp/{model_type}/bm{period}.ckpt')
